...
import me.aecsocket.calibre.world.user.RecoilableUser;
...
public interface PlayerUser extends LivingEntityUser, MovementUser, CameraUser, RecoilableUser, InaccuracyUser {
    Player entity();
